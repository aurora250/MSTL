...
void try_str() {
    ...
    string emptyStr;
    string hello = "Hello";
    string copyHello(hello);
    string repeated(5, 'A');

    cout << "Empty string: " << emptyStr << endl;
    cout << "Hello string: " << hello << endl;
    cout << "Copy of hello: " << copyHello << endl;
    cout << "Repeated string: " << repeated << endl;

    string world = " World!";
    string helloWorld = hello + world;
    cout << "Concatenated string: " << helloWorld << endl;

    cout << "First character of hello: " << hello[0] << endl;
    cout << "Last character of hello: " << hello.back() << endl;

    cout << "Length of hello: " << hello.length() << endl;
    size_t pos = helloWorld.find("World");
    if (pos != string::npos) {
        cout << "Found 'World' at position: " << pos << endl;
    } else {
        cout << "Did not find 'World'" << endl;
    }
    string replaceStr = helloWorld;
    replaceStr.replace(pos, 5, "Universe");
    cout << "Replaced string: " << replaceStr << endl;
    ...
    cout << "String from C-style string: " << fromCStr << endl;
}
